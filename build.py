...
for n in ['cpu-tweezers-cut','board-cut']:
    png=base64.b64encode(open(os.path.join(root,f'assets/{n}.png'),'rb').read()).decode()
    s=s.replace(f'assets/{n}.png',f'data:image/png;base64,{png}')
